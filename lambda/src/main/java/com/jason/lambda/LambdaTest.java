...
//        };
//
//        StudentDao sd3 = (Student student) -> System.out.println("student：" + student);
//
...
//
//
//        Supplier<String> s1 = () -> {return "jason";};
//        Supplier<String> s2 = () -> "jason2";
...
//
//        Runnable r2 = () -> exec();
////        Runnable 只有 run方法，没有返回值。所以不能直接返回。调用方法有返回值，默认不返回
////        Runnable r3 =() -> 100;
////        Runnable r4 = () -> ""
//
//        r1.run();
...
//        System.out.println(bf.apply("jason","cool"));
